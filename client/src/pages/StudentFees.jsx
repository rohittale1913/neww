    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-2">View and track your fee payments</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-lg border border-slate-100 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-slate-500 text-xs font-semibold uppercase">Total Amount Due</p>
          ...
          <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-lg border border-slate-100 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-slate-500 text-xs font-semibold uppercase">Amount Paid</p>
          ...
          <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-lg border border-slate-100 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-slate-500 text-xs font-semibold uppercase">Amount Pending</p>
          ...
          <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-lg border border-slate-100 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-slate-500 text-xs font-semibold uppercase">Overdue Fees</p>
              ...
              {loading ? (
                ...
                fees.map((fee) => (
                  <tr key={fee._id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-slate-600">{fee.academicYear || 'N/A'}</span>
                    </td>
                  </tr>
                ))
              )}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
          ...
          <ul className="space-y-2 text-slate-700 text-sm">
            <li>• Please ensure all fees are paid by the due date to avoid overdue charges</li>
            <li>• For payment inquiries, contact the accounting office</li>
            <li>• Keep receipts for all fee payments for your records</li>
