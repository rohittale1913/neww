...
import { FiPlus, FiUpload, FiCheckCircle, FiClock, FiAlertCircle, FiArrowRight } from 'react-icons/fi';
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start">
                  ...
                  <div className="md:col-span-1 flex flex-col justify-between h-full">
                    ...
                    <button
                      ...
                      className="mt-4 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium hover:shadow-lg transition inline-flex items-center justify-center gap-2 text-sm w-full"
                    >
                      View Submissions
